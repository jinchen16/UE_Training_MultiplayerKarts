...
void AKrazyKartsPawn::Steering(const FInputActionValue& Value)
{
...
void AKrazyKartsPawn::Throttle(const FInputActionValue& Value)
{
...
void AKrazyKartsPawn::Brake(const FInputActionValue& Value)
{
...
void AKrazyKartsPawn::StartBrake(const FInputActionValue& Value)
{
	// call the Blueprint hook for the break lights
	BrakeLights(true);
}

void AKrazyKartsPawn::StopBrake(const FInputActionValue& Value)
{
	// call the Blueprint hook for the break lights
	BrakeLights(false);
...
void AKrazyKartsPawn::StartHandbrake(const FInputActionValue& Value)
{
	// add the input
...
void AKrazyKartsPawn::StopHandbrake(const FInputActionValue& Value)
{
	// add the input
...
void AKrazyKartsPawn::LookAround(const FInputActionValue& Value)
{
...
void AKrazyKartsPawn::ToggleCamera(const FInputActionValue& Value)
{
...
void AKrazyKartsPawn::ResetVehicle(const FInputActionValue& Value)
{
